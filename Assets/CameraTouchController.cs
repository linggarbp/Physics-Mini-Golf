...
{
    [SerializeField, Range(0, 20)] float filterFactor = 5f;
    [SerializeField, Range(0, 10)] float dragFactor = 4f;
    [SerializeField, Range(0, 2)] float zoomFactor = 0.3f;
    ...
    void Update()
    {
        ...
        if (Input.touchCount == 1 && touch0.phase == TouchPhase.Moved)
        {
            ...
            //menggunakan Lerp (linear interpolation) sebagai filter agar movement lebih smooth
